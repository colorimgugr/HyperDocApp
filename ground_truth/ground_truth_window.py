...
class Ui_GroundTruthWidget(object):
    ...
    def retranslateUi(self, GroundTruthWidget):
        ...
        self.pushButton_class_selection.setText(_translate("GroundTruthWidget", "Select Ref"))
        ...
        self.comboBox_pixel_selection_mode.setItemText(1, _translate("GroundTruthWidget", "pixel"))
        self.comboBox_pixel_selection_mode.setItemText(2, _translate("GroundTruthWidget", "lasso"))
        self.comboBox_pixel_selection_mode.setItemText(3, _translate("GroundTruthWidget", "ellipse"))
