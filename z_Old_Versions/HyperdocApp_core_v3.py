...
from PyQt5.QtWidgets import (
    ...
    QSlider, QFileDialog, QHBoxLayout,QGraphicsView, QGraphicsScene, QGraphicsPixmapItem
)
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def open_hypercubes_and_GT(self,filepath=None):
        ...
        default_dir = os.getcwd()+"/HyperdocApp/minicubes"
        if not filepath:
    ...
    def update_metadata_label(self):
        ...
        match key:
            ...
            case 'date':
                st=f'Date of the capture : <b>{raw[0]}</b>'
