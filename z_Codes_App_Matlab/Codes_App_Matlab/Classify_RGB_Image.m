...
function [folder,baseFileName,classNames,classifiedImage1,classifiedImage2,classifiedImage3,classifiedImage4,classifiedImage5]=Classify_RGB_Image()
try
...
% 	startingFolder = fileparts(which('cameraman.tif')); % Determine where demo folder is (works with all versions).
	...
	[pixelColors, meanColors, outlines, classNames] = GetClassMeans(rgbImage);
...
function [pixelColors, meanColors, outlines, classNames] = GetClassMeans(rgbImage)
try
